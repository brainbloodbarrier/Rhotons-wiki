...
The foramen magnum is **oval-shaped**, wider posteriorly than anteriorly. The wider posterior part transmits the medulla; the narrower anterior part sits above the odontoid process of the axis.
...
### Atlas (C1)
Ring-shaped, lacks a vertebral body and spinous process. The **posterior arch** has a groove on its upper surface in which the [[vertebral-artery]] courses. This groove may be converted into a complete bony ring (ponticulus posticus) in 28% of specimens. The lateral masses bear the superior articular facets for the occipital condyles.

### Axis (C2)
Connected to the occipital bone by four ligaments:
- **Tectorial membrane** — cephalic extension of the posterior longitudinal ligament; covers the dens and cruciform ligament
- **Alar ligaments** — paired, arise from the upper dens, insert on the medial condylar surfaces
- **Apical ligament** — from the tip of the dens to the anterior foramen magnum margin
- **Cruciform ligament** — transverse part (transverse ligament of atlas) spans between lateral masses; vertical part ascends to the anterior foramen magnum margin

### Atlanto-occipital membranes
- **Anterior** — from the anterior foramen magnum margin to the anterior arch of the atlas
- **Posterior** — from the posterior foramen magnum margin to the upper border of the posterior arch; its lateral border arches behind the [[vertebral-artery]] and C1 nerve root
...
The foramen magnum is surrounded by layered suboccipital musculature:
- **Superficial layer** — trapezius, sternocleidomastoid
- **Middle layer** — splenius capitis, semispinalis capitis, longissimus capitis
- **Deep layer (suboccipital triangle)** — superior oblique, inferior oblique, rectus capitis posterior major and minor
...
- Located in the occipital bone of the [[cranial-base]]
- Transmits the cervicomedullary junction, [[vertebral-artery|vertebral arteries]], [[lower-cranial-nerves|CN XI]]
- [[pica]] origin near or below the foramen
- Closely related to [[basilar-artery]] (formed just above)
- Jugular foramen lateral and slightly superior (transmits CN IX, X, XI)
- Hypoglossal canal above the occipital condyle (transmits [[lower-cranial-nerves|CN XII]])
- Cerebellar tonsils sit above posterior edge (herniation through the foramen)
- [[basal-cisterns|Cisterna magna]] located behind the foramen
- Suboccipital triangle overlies the V3 [[vertebral-artery]] segment
- Exposed via [[far-lateral-approach]], suboccipital craniectomy, [[transsphenoidal-approach|anterior approaches]]

## References

- Rhoton, Ch.14 — The Foramen Magnum (osseous anatomy, ligaments, musculature, neurovascular contents, surgical approaches)
