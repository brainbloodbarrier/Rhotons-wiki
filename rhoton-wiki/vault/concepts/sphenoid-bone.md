...
### Pterygoid processes
Descend vertically from the junction of the body and greater wings:
- **Medial pterygoid plate** — borders the posterior nasal aperture (choana); relevant to [[transsphenoidal-approach]] corridor
- **Lateral pterygoid plate** — attachment of the pterygoid muscles
- **Pterygoid (Vidian) canal** — transmits the Vidian nerve (from greater petrosal + deep petrosal); landmark for the petrous [[internal-carotid-artery|ICA]] during endonasal surgery

## Sphenoid Sinus

Variable pneumatization — classified as:
- **Conchal** — minimal pneumatization (thick bone anterior to the sella)
...
- Central bone of the [[cranial-base]] — articulates with all cranial bones
- Sella turcica houses the [[pituitary-gland]] within the [[sellar-region]]
- [[cavernous-sinus]] lies lateral to the body
- [[optic-nerve]] and [[ophthalmic-artery]] traverse the optic canal
- [[internal-carotid-artery]] (C3) courses through/beside the body in the [[cavernous-sinus]]
- [[trigeminal-nerve]] divisions exit through three sphenoid foramina
- Sphenoid sinus = corridor for [[transsphenoidal-approach]]
- Sphenoid ridge = landmark for [[pterional-approach]]
- Greater wing floor = middle fossa approaches
- See [[cranial-nerves-overview]] for all foraminal contents
- See [[surgical-approaches-overview]] for approach planning

## References

- Rhoton, Ch.6 — The Anterior and Middle Cranial Base
- Rhoton, Ch.7 — The Orbit (optic canal, superior orbital fissure)
- Rhoton, Ch.8 — The Sellar Region (sphenoid sinus, sella turcica)
- Rhoton, Ch.9 — The Cavernous Sinus (cavernous sinus relation to sphenoid body)
