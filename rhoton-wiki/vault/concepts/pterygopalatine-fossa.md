...
- **Anterior** — posterior wall of the maxillary sinus ([[paranasal-sinuses]])
- **Posterior** — pterygoid process of the [[sphenoid-bone]] and greater wing
- **Medial** — perpendicular plate of the palatine bone (lateral nasal wall)
- **Superior** — inferior surface of the sphenoid body (floor of middle cranial fossa)
- **Lateral** — open; communicates with the [[infratemporal-fossa]] via the pterygomaxillary fissure

## Communications (8 pathways)

| Communication | Via | Leads to |
|---|---|---|
| Middle cranial fossa | Foramen rotundum | [[sphenoid-bone]], [[cranial-base]] |
| [[orbit]] | Inferior orbital fissure | Orbital floor |
| Nasal cavity | Sphenopalatine foramen | Lateral nasal wall |
| [[infratemporal-fossa]] | Pterygomaxillary fissure | Lateral skull base |
| Oral cavity (palate) | Greater and lesser palatine canals | Hard and soft palate |
| Pharynx | Pharyngeal (palatovaginal) canal | Nasopharynx roof |
| Middle cranial fossa | Vidian (pterygoid) canal | Foramen lacerum area |
| [[orbit]] | Infraorbital canal | Orbital floor, cheek |

## Contents

### Neural
- **[[trigeminal-nerve|V2]] (maxillary nerve)** — enters through foramen rotundum from the [[cranial-base|middle cranial fossa]]; divides into:
  - **Infraorbital nerve** — exits through the infraorbital canal/foramen to the cheek
...
V2 can be followed from the PPF through foramen rotundum back to [[meckels-cave]] — used for percutaneous trigeminal procedures and V2 schwannoma resection.

## Relations

- [[trigeminal-nerve|V2]] (maxillary nerve) enters from foramen rotundum ([[sphenoid-bone]])
- Maxillary artery terminal branches from the [[infratemporal-fossa]]
- Pterygopalatine ganglion receives [[facial-nerve|CN VII]] parasympathetics via Vidian nerve
- Communicates with [[orbit]] (inferior orbital fissure)
- Communicates with nasal cavity → [[paranasal-sinuses]] (sphenopalatine foramen)
- Vidian canal leads to the petrous [[internal-carotid-artery|ICA]]
- [[cranial-base]] (middle fossa floor) forms the roof
- Accessed endoscopically as extension of [[transsphenoidal-approach]]
- See [[skull-base-foramina]] for foramen rotundum
- See [[cranial-nerves-overview]] for V2 course
