---
title: Basal Ganglia and Internal Capsule
category: concepts
tags:
  - anatomy
  - cerebrum
...
### Caudate nucleus
C-shaped, wrapping around the [[thalamus]] along the lateral ventricle:
- **Head** — bulges into the frontal horn (lateral wall); related to the foramen of Monro
- **Body** — forms part of the lateral ventricle floor
- **Tail** — curves into the temporal horn roof

### Lentiform nucleus
Wedge-shaped mass lateral to the internal capsule, deep to the [[insula]]:
- **Putamen** — the larger, lateral portion; separated from the insula by the extreme capsule, claustrum, and external capsule
- **Globus pallidus** — the medial portion (internal and external segments); separated from the thalamus by the posterior limb of the internal capsule

### Other nuclei
- **Nucleus accumbens** — at the junction of the caudate head and putamen
- **Subthalamic nucleus** — in the diencephalon, below the thalamus; DBS target for Parkinson's disease
- **Substantia nigra** — in the [[brainstem]] (midbrain cerebral peduncle)

## Internal Capsule

The internal capsule is a V-shaped white matter band (in axial section) with an apex (genu) pointing medially:
...
Basal ganglia (putaminal) hemorrhage is the most common hypertensive intracerebral hemorrhage. Blood dissects through the lentiform nucleus and internal capsule. Surgical evacuation via transsylvian ([[pterional-approach]]) or transcortical approaches.

### Aneurysm surgery
Lenticulostriate arteries are at risk during:
- [[middle-cerebral-artery]] bifurcation aneurysm clipping — [[pterional-approach]]
- [[anterior-communicating-artery]] aneurysm surgery — Heubner artery preservation
- [[internal-carotid-artery]] bifurcation aneurysm clipping

### Deep brain stimulation
- **Subthalamic nucleus** — DBS target for Parkinson's disease
- **Globus pallidus internus** — DBS target for dystonia
- **Vim of [[thalamus]]** — DBS for essential tremor

### Insular glioma surgery
Resection of [[insula|insular tumors]] requires navigating between the MCA branches on the insular surface and the lenticulostriates entering the anterior perforated substance.

## Relations

- Located deep within the [[cerebrum]], lateral to [[thalamus]]
- [[lateral-and-third-ventricles|Lateral ventricle]] wraps around the caudate nucleus
- [[insula]] lies superficial to the putamen (separated by capsules)
- Supplied by [[middle-cerebral-artery]] (lateral lenticulostriates) and [[anterior-cerebral-artery]] (medial lenticulostriates, Heubner) — see [[anterior-circulation]]
