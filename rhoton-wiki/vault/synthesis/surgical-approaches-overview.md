...
### 1. Shortest trajectory to the target
Choose the approach that provides the most direct corridor without crossing critical structures. The [[pterional-approach]] provides the widest access to the anterior [[circle-of-willis]] because the [[sylvian-fissure]] is a natural cleavage plane.

### 2. Cistern-based corridors
...
- All approaches target structures within the [[basal-cisterns]]
- Arterial anatomy: [[circle-of-willis]], [[vertebral-artery]], [[basilar-artery]] determine approach angle
- Venous anatomy: [[cerebral-veins]], [[posterior-fossa-veins]], [[dural-venous-sinuses]] constrain corridors
- Neural anatomy: all cranial nerves from [[oculomotor-nerve|CN III]] to [[lower-cranial-nerves|CN XII]] are encountered
- Skull base: [[cranial-base]], [[foramen-magnum]], [[cavernous-sinus]], [[sellar-region]]
- [[brainstem]] safe entry zones are the ultimate target for intrinsic lesions
