...
The skull base contains numerous foramina through which cranial nerves, arteries, and veins pass between the intracranial cavity and extracranial structures. Knowledge of foraminal contents is essential for approach planning and intraoperative orientation. This page provides a complete reference map organized by cranial fossa.

## Anterior Cranial Fossa

| Foramen | Bone | Contents | Related page |
|---|---|---|---|
| **Cribriform plate foramina** | Ethmoid | CN I (olfactory nerve filaments) | [[cranial-base]] |
...
| **Posterior ethmoidal foramen** | Frontoethmoidal suture | Posterior ethmoidal artery ([[ophthalmic-artery]]), posterior ethmoidal nerve | [[paranasal-sinuses]] |
...
| Foramen | Bone | Contents | Related page |
|---|---|---|---|
| **Internal acoustic meatus** | [[temporal-bone]] (petrous) | [[facial-nerve\|CN VII]], [[vestibulocochlear-nerve\|CN VIII]], labyrinthine artery ([[aica]]), nervus intermedius | [[temporal-bone]] |
...
| Approach | Key foramina in the surgical field |
|---|---|
| [[pterional-approach]] | Optic canal, superior orbital fissure |
| [[transsphenoidal-approach]] | Sphenoid ostia → sellar floor (not a true foramen) |
| [[subtemporal-approach]] | Foramen ovale, foramen spinosum, hiatus of greater petrosal nerve |
| [[anterior-petrosectomy]] | Hiatus of greater petrosal nerve, porus trigeminus |
| [[retrosigmoid-approach]] | Internal acoustic meatus (drilled posteriorly) |
| [[far-lateral-approach]] | [[foramen-magnum]], hypoglossal canal, jugular foramen |
| [[orbitozygomatic-approach]] | Optic canal, superior orbital fissure |
| Percutaneous trigeminal | Foramen ovale (needle entry) |

## Relations

- [[cranial-base]] is the bony framework containing all foramina
- [[sphenoid-bone]] contains the most middle fossa foramina (optic canal, SOF, rotundum, ovale, spinosum)
- [[temporal-bone]] contains IAC, jugular foramen (partial), hiatus for petrosal nerves
- Occipital bone contains [[foramen-magnum]], hypoglossal canal, jugular foramen (partial)
- All cranial nerves (see [[cranial-nerves-overview]]) exit through specific foramina
- [[anterior-circulation]] (ICA, [[ophthalmic-artery]]) enters via the carotid canal and optic canal
- [[posterior-circulation]] ([[vertebral-artery]]) enters via the [[foramen-magnum]]
- [[dural-venous-sinuses]] exit via the jugular foramen (sigmoid → IJV)
- [[cavernous-sinus]] is the intracranial venous hub receiving and distributing through multiple foramina
- See [[surgical-approaches-overview]] for approach-foraminal correlation

## References

- Rhoton, Ch.6 — The Anterior and Middle Cranial Base (anterior and middle fossa foramina)
- Rhoton, Ch.7 — The Orbit (optic canal, superior orbital fissure)
- Rhoton, Ch.9 — The Cavernous Sinus (Dorello's canal, cavernous sinus entries)
- Rhoton, Ch.14 — The Foramen Magnum (posterior fossa foramina, jugular foramen, hypoglossal canal)
