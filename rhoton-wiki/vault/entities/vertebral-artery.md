...
### V1 — Preforaminal (extraosseous)
Extends from the subclavian artery origin to the C6 transverse foramen (occasionally C5 or C7). Courses posterosuperiorly between the longus colli and scalenus anterior muscles.

### V2 — Foraminal (intraosseous)
...
**Caliber:** The intradural diameter averages 4.4 mm at dural entry, 3.9 mm at [[pica]] origin, and 3.7 mm at the vertebrobasilar junction. The left vertebral artery is dominant (larger) in the majority of cases.
...
The primary corridor for vertebral artery pathology at the foramen magnum. The V3 segment is identified in the suboccipital triangle between the C1 and C2 transverse processes, then traced to its dural entry. The approach provides exposure of the anterolateral foramen magnum, vertebral artery, and vertebrobasilar junction.
...
- **Vertebral artery aneurysms** — approached via [[far-lateral-approach]] with or without transcondylar extension
- **Vertebrobasilar insufficiency** — stenosis of V1–V4 segments produces posterior circulation ischemia
- **Bow hunter syndrome** — dynamic V3 compression during head rotation due to atlantoaxial instability

## Variations

- Asymmetry is the rule: the left vertebral artery is larger in most cases
- The vertebral artery may terminate as PICA without forming the basilar artery
- Both vertebral artery and PICA may be absent on one side
- The V3 segment may be encased in a complete bony ring on the atlas (arcuate foramen / ponticulus posticus)
- Extradural origin of PICA may occur from V3 segment below the foramen magnum

## Relations

- Origin: first branch of subclavian artery
- Courses through transverse foramina C6–C1
- Traverses suboccipital triangle (V3 segment)
- Enters [[posterior-fossa]] through foramen magnum
- Gives rise to [[pica]], posterior and anterior spinal arteries
- Joins contralateral vertebral artery to form basilar artery
- Closely related to [[superior-cerebellar-artery]] and [[aica]] via basilar trunk
- The [[circle-of-willis]] is completed posteriorly via the basilar → [[posterior-cerebral-artery]] → [[posterior-communicating-artery]] pathway
- Exposed in [[far-lateral-approach]], [[retrosigmoid-approach]]
- Related to [[basal-cisterns]] (cisterna magna)
- Lower cranial nerves (IX–XII) intimately related at foramen magnum level

## References

- Rhoton, Ch.10 — The Posterior Cranial Fossa
- Rhoton, Ch.12 — The Superior Cerebellar Artery (PICA origin and vertebral artery)
- Rhoton, Ch.14 — The Foramen Magnum (vertebral artery course, relations, approaches)
