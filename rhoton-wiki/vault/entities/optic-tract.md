...
```
Retina → [[optic-nerve]] → [[optic-chiasm]] → Optic Tract → Lateral Geniculate Body → Optic Radiations → Visual Cortex
```

Each optic tract carries:
- **Temporal retinal fibers** from the ipsilateral eye (uncrossed at chiasm)
- **Nasal retinal fibers** from the contralateral eye (crossed at chiasm)

A lesion of one optic tract produces **contralateral homonymous hemianopia** (loss of the opposite visual field in both eyes).
...
- Continuation of: [[optic-chiasm]] (post-chiasmatic visual pathway)
- Terminates at: lateral geniculate body of [[thalamus]]
- Adjacent arteries: [[anterior-choroidal-artery]], [[posterior-communicating-artery]], [[posterior-cerebral-artery]]
- Adjacent veins: [[basal-vein-of-rosenthal]]
- Lateral to: [[hypothalamus]], [[pituitary-gland|pituitary stalk]]
- Medial to: uncus of temporal lobe
- Wraps around: cerebral peduncle of [[brainstem]]
- Compressed in: [[herniation-syndromes|uncal herniation]]
