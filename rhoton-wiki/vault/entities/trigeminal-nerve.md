...
The [[superior-cerebellar-artery]] frequently contacts CN V in the [[cerebellopontine-cistern]]. Pulsatile compression causes **trigeminal neuralgia** — treated by microvascular decompression via the [[retrosigmoid-approach]].

## Surgical Significance

- The superior petrosal veins converge near CN V — may need division during [[retrosigmoid-approach]]
- Schwannomas of CN V span the posterior and middle fossae via Meckel's cave
- V1 is at risk during [[cavernous-sinus]] surgery
- V3 passes through foramen ovale — landmark in middle fossa approaches ([[cranial-base]])

## References

- Rhoton, Ch.9 — The Cavernous Sinus
- Rhoton, Ch.12 — Superior Cerebellar Artery
