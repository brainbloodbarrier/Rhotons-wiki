...
aliases:
  ...
  - "chiasma opticum"
sources:
  - "Rhoton - Cranial Anatomy and Surgical Approaches (2023), Ch.1–2, 8"
created: 2026-04-09
updated: 2026-04-09
summary: >-
  Visual pathway crossing, sellar region landmark
...
- **Anterior** — optic nerves entering optic canals
...
This multi-source supply is why chiasmal ischemia is relatively uncommon despite the critical location.

## Surgical Significance

- **Pituitary adenomas** — compress the chiasm from below, causing bitemporal hemianopia (classic visual field defect)
- **Craniopharyngiomas** — may displace the chiasm superiorly or posteriorly
- **Meningiomas** (tuberculum sellae, planum sphenoidale) — compress from anterior/inferior
- The chiasm is a key landmark in both transcranial (subfrontal, [[pterional-approach]]) and endonasal transphenoidal approaches to the [[sellar-region]]
- The optic nerves course through the optic canals into the [[orbit]]
- The **prefixed chiasm** makes transsphenoidal suprasellar access more difficult; a **postfixed chiasm** provides a wider subfrontal corridor
