...
aliases:
  ...
  - "nervus abducens"
sources:
  - "Rhoton - Cranial Anatomy and Surgical Approaches (2023), Ch.9, 14"
created: 2026-04-09
updated: 2026-04-09
summary: >-
  CN VI, longest subarachnoid course, Dorello's canal
parent: "[[cranial-nerves-overview]]"
---

# Abducens Nerve

The abducens nerve (CN VI) has the **longest intracranial subarachnoid course** of any cranial nerve, making it uniquely vulnerable to pathology along its trajectory. It innervates the lateral rectus muscle and is the sole motor nerve for eye abduction.
...
Within the [[cavernous-sinus]], CN VI has the most **medial position** of all nerves traversing the sinus. It courses:
- Lateral to the [[internal-carotid-artery|intracavernous carotid artery]]
- Medial to the ophthalmic division of [[trigeminal-nerve|CN V1]]
- Below and medial to the nasociliary nerve
- Adherent to both the lateral surface of the carotid medially and the medial surface of the ophthalmic nerve laterally

Unlike CN III, IV, and V1 which course in the lateral sinus wall, **CN VI courses freely within the sinus itself**, making it the first nerve affected by cavernous sinus pathology.

The nerve usually enters the sinus as a single bundle but may split into up to 5 rootlets as it courses between the ICA and ophthalmic nerve. In a study of 50 sinuses: single rootlet in 34 (68%), two rootlets in 13 (26%), three in 2, and five in 1.

**Sympathetic fibers** from the carotid plexus join CN VI within the sinus before being distributed to the ophthalmic division (V1) — these carry pupillodilator fibers via the long ciliary nerves.

## Superior Orbital Fissure and Orbit

CN VI passes through the superior orbital fissure within the annulus of Zinn (tendinous ring) and enters the [[orbit]] to innervate the lateral rectus muscle on its deep surface.
...
CN VI palsy is a classic **false localizing sign** of raised intracranial pressure. Caudal displacement of the brainstem stretches the nerve at its fixed point of dural entry (Dorello's canal), producing lateral rectus paralysis without a local lesion.

## Relations

- Emerges from pontomedullary junction, ascends through prepontine cistern
- Closely related to [[basilar-artery]] and [[aica]] at the pons
- Enters [[cavernous-sinus]] via Dorello's canal below petrosphenoid ligament
- Courses medial to [[trigeminal-nerve|V1]], lateral to [[internal-carotid-artery|ICA]]
- Adjacent to [[oculomotor-nerve|CN III]] and CN IV at the cavernous sinus
- Passes through superior orbital fissure to [[orbit]]
- Exposed in [[pterional-approach]], [[retrosigmoid-approach]], anterior petrosectomy
- Related to [[sellar-region]] (dorsum sellae) and [[cranial-base]] (petrous apex)
