...
The vestibulocochlear nerve transmits auditory (cochlear) and vestibular (balance) information from the inner ear to the brainstem. It is the nerve from which vestibular schwannomas (acoustic neuromas) most commonly arise.

## Components

- **Cochlear nerve** — arises from spiral ganglion in cochlea; transmits auditory information
- **Superior vestibular nerve** — from superior and lateral semicircular canals and utricle
- **Inferior vestibular nerve** — from posterior semicircular canal and saccule; **most common origin of vestibular schwannomas**
...
Vestibular schwannomas (acoustic neuromas) arise from Schwann cells of the inferior vestibular nerve. They grow from the canal into the [[cerebellopontine-cistern]], displacing the [[facial-nerve]] anteriorly. Surgical approaches include [[retrosigmoid-approach]], translabyrinthine, and middle fossa.
