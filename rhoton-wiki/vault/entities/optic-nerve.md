...
aliases:
  ...
  - "nervus opticus"
sources:
  - "Rhoton - Cranial Anatomy and Surgical Approaches (2023), Ch.2, 7, 8"
created: 2026-04-09
updated: 2026-04-09
summary: >-
...
### Arterial
- **[[internal-carotid-artery]]** — the supraclinoid ICA lies lateral to the optic nerve; the ophthalmic artery arises from the ICA and enters the optic canal with the nerve
...
The optic nerve is one of the first structures identified. The **opticocarotid triangle** (between the optic nerve, ICA, and A1) provides the corridor to the [[basilar-artery]] apex and [[posterior-communicating-artery]]. The nerve must be protected during aneurysm clipping.
...
- **Pituitary adenoma** — compresses [[optic-chiasm]] from below → bitemporal hemianopia
- **Optic nerve meningioma** — compresses the nerve within the orbit or canal → monocular vision loss
- **Optic nerve glioma** — intrinsic tumor, especially in neurofibromatosis
- **Papilledema** — CSF in the optic nerve sheath transmits raised ICP → disc swelling
- **Traumatic optic neuropathy** — fracture through the optic canal
...
- [[basal-cisterns]] (suprasellar/chiasmatic cistern)

## References

- Rhoton, Ch.2 — The Supratentorial Arteries (opticocarotid triangle)
- Rhoton, Ch.7 — The Orbit (intraorbital optic nerve)
- Rhoton, Ch.8 — The Sellar Region (suprasellar visual pathway)
