---
title: Thalamoperforating Arteries
category: entities
tags:
  - anatomy
  - vasculature
...
### From P1 Segment of PCA
The majority of thalamoperforating arteries arise from the **P1 (precommunicating) segment** of the [[posterior-cerebral-artery]], between the [[basilar-artery]] bifurcation and the [[posterior-communicating-artery]] junction. Variants include:

- **Direct P1 origin** — most common; multiple small branches
- **Artery of Percheron** — a single dominant trunk from one P1 supplying both thalami; occlusion produces bilateral thalamic infarction
...
| Territory | Clinical Consequence of Infarction |
|---|---|
...
## Relationship to Basilar Apex Aneurysms

Basilar apex aneurysm surgery is among the most demanding in cerebrovascular neurosurgery, largely because of the thalamoperforating arteries:

- The perforators arise from the **posterior wall** of the P1 and basilar tip — directly behind the aneurysm neck
- They are stretched, displaced, or adherent to the aneurysm fundus
- **Clip placement** must avoid occluding or kinking the perforators
- The [[subtemporal-approach]] and [[orbitozygomatic-approach]] provide different angles to visualize the perforators behind the aneurysm

### Approach Considerations

| Approach | Perforator Visualization |
|---|---|
| [[pterional-approach]] | Limited view of posterior perforators behind basilar apex |
| [[orbitozygomatic-approach]] | Better low-angle view; improved perforator visualization |
| [[subtemporal-approach]] | Lateral view; good for posteriorly projecting aneurysms |

## Relationship to Other Perforators

The thalamoperforating arteries are part of the broader [[perforating-arteries]] system:

| Perforator Group | Origin | Territory |
|---|---|---|
...
- Origin: [[posterior-cerebral-artery]] (P1), [[basilar-artery]] (apex), [[posterior-communicating-artery]]
- Penetrate: posterior perforated substance (interpeduncular fossa)
- Supply: [[thalamus]], subthalamus, rostral [[brainstem|midbrain]]
- At risk in: basilar apex aneurysm surgery
- Variant: artery of Percheron (bilateral thalamic supply)
- Part of: [[perforating-arteries]] system
- Approached via: [[pterional-approach]], [[orbitozygomatic-approach]], [[subtemporal-approach]]
