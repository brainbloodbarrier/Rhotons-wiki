...
The basilar bifurcation into the posterior cerebral arteries is a critical surgical landmark:
...
Arises from the basilar apex just below the PCA origin. Passes below the [[oculomotor-nerve|CN III]] and above the [[trigeminal-nerve|CN V]], encircles the midbrain to supply the tentorial cerebellar surface. Supplies the **upper neurovascular complex** of the [[posterior-fossa]].
...
Terminal bifurcation. The P1 segment extends from the basilar apex to the junction with the [[posterior-communicating-artery]], completing the posterior limb of the [[circle-of-willis]].
...
- **CN VII/VIII** — the [[facial-nerve]] and [[vestibulocochlear-nerve]] are closely related to the AICA as it courses through the [[cerebellopontine-cistern|cerebellopontine angle]]
- **CN V** — the [[trigeminal-nerve]] exits the lateral pons between the SCA (above) and AICA (below)
...
Among the most challenging intracranial aneurysms. Approached via the [[pterional-approach]] (most common), [[transsphenoidal-approach|anterior transpetrosal]], or subtemporal corridors. The bifurcation height determines the optimal approach: high bifurcations favor pterional, low bifurcations may require subtemporal or combined approaches.

### Vertebrobasilar junction
Exposed by the [[far-lateral-approach]] with transcondylar extension, providing access to the lower third of the basilar artery, the vertebrobasilar junction, and both vertebral arteries.

### Clival exposure
Anterior approaches through the clivus (endonasal, transoral) expose the basilar artery on the anterior pons. Opening the clivus reveals both the vertebral arteries, the basilar trunk, and the AICA origins.

### Perforator preservation
The pontine perforating branches are the principal constraint in basilar artery surgery. These tiny vessels are invisible on preoperative imaging and must be identified and preserved during dissection.
...
- Formed by union of paired [[vertebral-artery|vertebral arteries]] at pontomedullary junction
- Ascends on ventral pons within prepontine cistern
- Gives rise to [[aica]], [[superior-cerebellar-artery]], pontine perforators
- Terminates as paired [[posterior-cerebral-artery|PCAs]]
- Closely related to CN III ([[oculomotor-nerve]]), CN V ([[trigeminal-nerve]]), CN VI, CN VII ([[facial-nerve]]), CN VIII ([[vestibulocochlear-nerve]])
- Completes posterior [[circle-of-willis]] via PCA → [[posterior-communicating-artery]]
- Exposed by [[pterional-approach]], [[far-lateral-approach]], [[retrosigmoid-approach]]
- Courses through [[basal-cisterns]] (prepontine, interpeduncular)
