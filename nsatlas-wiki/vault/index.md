...
| [[pathology/]] | 25 | Disease-specific operative chapters (recent: brain-abscess, hemangioblastoma, ependymoma, cavernous-malformation) |
...
- [[preoperative-evaluation]] -- ASA stratification, system-based workup, neurosurgical-scenario specifics
...
- [[cranial-base-surgery-lessons-learned]] -- Cohen-Gadol's decade of pearls: dynamic retraction, arachnoid-handle nerve mobilization, seated ergonomics, 12h staging rule
- [[cranial-base-preoperative-considerations]] -- workup, instrumentation, positioning, IOM per corridor for skull base cases
- [[cranial-base-operative-corridor-selection]] -- anatomic decision tree for anterior/middle/posterior/craniocervical skull base approaches
- [[imaging-sah-and-aneurysm]] -- CT/CTA/MRA/DSA workup of SAH + aneurysm, Fisher/Hunt-Hess scales, delayed ischemia imaging
- [[neuroradiology-imaging-modalities]] -- overview of CT, MRI sequences, DSA, functional imaging, DTI, perfusion
- [[neuroradiology-preface]] -- introduction to neuroradiology for neurosurgeons

### Pathology

- [[medial-sphenoid-wing-meningioma]] -- medial SW meningioma: clinoidal variants, ICA/optic nerve encasement, pterional + clinoidectomy strategy
- [[geniculate-neuralgia]] -- nervus intermedius neuralgia: ear-deep lancinating pain, MVD via retromastoid, CN VII/VIII relationships
- [[glossopharyngeal-neuralgia]] -- CN IX neuralgia: throat/ear pain, syncope variant, MVD with PICA loop conflict
- [[hemifacial-spasm]] -- unilateral facial tics from CN VII compression, AICA/PICA loops, MVD technique + LSR monitoring
- [[menieres-disease]] -- vestibular MVD for refractory Meniere's, CN VIII root-entry zone, endolymphatic shunting alternatives
- [[trigeminal-neuralgia-mvd]] -- classic CN V neuralgia, SCA/AICA conflict, MVD via retromastoid with Teflon interposition
