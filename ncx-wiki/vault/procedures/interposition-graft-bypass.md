---
title: Interposition Graft Bypass
category: procedures
tags:
  - ncx
  - microsurgical
...
updated: 2026-04-15
summary: >-
  High-flow EC-IC bypass using radial artery or saphenous vein interposition
  grafts to connect the cervical carotid artery to intracranial recipients.
  Second-generation bypass designed to replace or restore carotid blood flow
  after deliberate sacrifice.
complementary-to:
  - "[[ec-ic-bypass]]"
...
The [[saphenous-vein]] graft (SVG) is the alternative when RAG is unavailable. SVGs are more collapsible, and their valves impose directionality -- narrower distal end in the neck, wider proximal end in the head. Cryopreserved allograft SVG serves as an "off the shelf" option for emergency trapping and bypass.
...
The intracranial anastomosis is performed first because the free graft's mobility is an advantage -- it can flip frontally for the first suture line and temporally for the second. End-to-side technique with 9-0 (rather than 10-0) nylon suture accommodates the thicker graft walls. RAGs are inserted anterograde (wider elbow end in neck, narrower wrist end in head) since they lack valves. Fish-mouthing of the RAG enlarges the anastomotic area, while SVGs use perpendicular "T-bone" transection to minimize size mismatch.

## Tunneling Technique

A subcutaneous tunnel is created with blunt spreading dissection between the cranial and cervical incisions. A chest tube passed through the tunnel guides the graft from the [[sylvian-fissure]] to the neck. A clear chest tube and the Garrett line prevent twists. Distending the graft with trapped heparinized saline also prevents kinks. The submuscular tunnel under the [[temporalis-muscle]] is an alternative that offers a more direct route, saving several centimeters of length for short grafts.

Critically, blood must not stagnate in the graft between the first and second anastomoses. A temporary clip on the graft proximal to the intracranial anastomosis keeps it flushed with heparinized saline while the proximal anastomosis is completed.

## Clinical Applications

| Indication | % |
|---|---|
| Cavernous ICA aneurysm | 34% |
| Supraclinoid ICA aneurysm | 31% |
| MCA aneurysm | 10% |
| Skull base tumor | 7% |
| Carotid/MCA occlusion | 7% |
| [[moyamoya-disease]] | 2% |
| Basilar [[aneurysm]] | 3% |

Flow diverters have progressively reduced bypass indications for cavernous [[aneurysm]]s, with only seven such bypasses performed in Lawton's last decade of practice. The RAG has become the graft of first choice in the current era, with SVGs reserved for patients without suitable autologous arterial grafts.
