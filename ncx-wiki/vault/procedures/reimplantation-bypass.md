...
aliases:
  - IC-IC reimplantation
  - branch reimplantation bypass
  - reimplantation
sources:
...
updated: 2026-04-15
summary: >-
  Intracranial-intracranial reimplantation bypass using end-to-side anastomosis
  to reattach an efferent branch detached from an aneurysm onto an adjacent
  donor artery. Performed within four anatomic triangles corresponding to MCA,
  ACA, PCA/SCA, and PICA territories.
complementary-to:
  - "[[ec-ic-bypass]]"
...
Reimplantation is Lawton's third-generation IC-IC bypass, using an end-to-side anastomosis to join an efferent branch deliberately detached from an [[aneurysm]] to an adjacent intracranial artery with robust donor flow. It is the technical equivalent of the [[ec-ic-bypass]] with a reversed donor-recipient relationship: in the STA-MCA bypass the reimplanted scalp artery is the revascularizing donor, whereas in reimplantation the reimplanted artery is the revascularized recipient. The convergent [[ec-ic-bypass]] adds extracranial flow; the divergent reimplantation draws intracranial flow from the donor.

Reimplantation was the least frequently performed of Lawton's seven bypasses (4% of overall experience, 21 cases), because it requires that the detached efferent artery and a nearby donor have both the mobility and the proximity to join within the surgical field. These requirements are met within four key anatomic triangles.

## The Four Anatomic Triangles
...
### Vago-Accessory Triangle (PICA Reimplantation)
...
The anastomosis uses a long linear arteriotomy in the donor and a fish-mouth arteriotomy in the recipient, sewn extraluminally with standard technique. If the recipient has limited mobility and cannot rotate, the first suture line is sewn intraluminally with the in-situ technique.

Key technical considerations:
- **Distal mobilization** of the recipient compensates for length lost during transection and decreases tension, whereas proximal mobilization increases tension and dooms the anastomosis
- **Sacrificing a critical perforator** to eloquent brain is never acceptable, but insular perforators or small temporal pole branches are expendable
- **The search for donors** should be directed distal to the aneurysm, where uninvolved bystander arteries offer reimplantation targets

| Reimplantation Type | Cases | % |
|---|---|---|
| PICA-V4 VA reimplantation | 10 | 48% |
| M2 MCA-M2 MCA | 4 | 19% |
| ACA variants | 3 | 14% |
| PCA/SCA | 1 | 5% |
| Other | 3 | 14% |
...
- [[ec-ic-bypass]] -- low-flow EC-IC bypass, the technical equivalent with reversed donor-recipient roles
