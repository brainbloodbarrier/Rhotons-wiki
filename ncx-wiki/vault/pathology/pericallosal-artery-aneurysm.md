---
title: Pericallosal Artery Aneurysm
category: pathology
tags:
  - ncx
  - aneurysm
...
Eight cortical branches: [[orbitofrontal-artery]], [[frontopolar-artery]], anterior/middle/posterior internal frontal arteries, [[paracentral-artery]], and superior/inferior parietal arteries. The branching pattern is highly variable and provides minimal anatomic guidance during fissure dissection.

### Anomalies

- **Azygos ACA**: unpaired midline artery that bifurcates, trifurcates, or quadrifurcates at the aneurysm base
- **Accessory A2**: triplication of A2 segments
- **Bihemispheric ACA**: one A2 supplies both hemispheres

## Dissection Strategy

### Opening the Interhemispheric Fissure
...
| Location | Segments | Head Position | Dissection |
|---|---|---|---|
| Proximal (low) | A2 | Neutral | Almost along anterior fossa floor; falx thin, long subarachnoid distance |
| Middle (genu) | A3 | Neutral | More accessible proximal control |
| Distal (high) | A4-A5 | Lateral (gravity retraction) | Wide posterior falx shortens subarachnoid distance |
...
6. Identify and mobilize contralateral CmaA (clear false trunks)
7. Trace ipsilateral CmaA retrograde to the neck
8. Dissect contralateral PcaA similarly
9. Dissect efferent PcaA along its inner surface to the neck

### Six Major Arteries

Despite being a distal aneurysm, proximity to the contralateral bifurcation involves six arteries: bilateral PcaAs, bilateral CmaAs, and bilateral afferent ACAs. Contralateral arteries frequently adhere to the dome in the narrow corpus callosum cistern, creating **false trunks** that must be traced to their final territory.

## Clipping Technique

### Proximal and Middle Aneurysms

The axial view into the convergence of PcaA and CmaA often permits clipping with a **single straight or curved clip**, or **multiple stacked clips**. Draped arteries on the dome may require fenestrated clips. An incompletely opened cleavage plane between the neck and an efferent artery also calls for fenestrated clipping that encircles the stuck artery.

### Distal Aneurysms

The aneurysm axis and efferent convergence project away from the neurosurgeon. Require **fenestrated clips** or **intersecting curved clips** (down-curved for superior neck, up-curved for inferior neck, blades must intersect to close completely).

### Bypass Options

The interhemispheric fissure is excellent for in situ bypasses:

- **A3-A3 bypass**: side-to-side anastomosis of parallel ACAs
- **PcaA-CmaA reimplantation**: when an efferent artery is compromised
- **PcaA excision-reanastomosis**: end-to-end for fusiform aneurysms
- **Radial artery interposition graft**: for complex reconstructions
