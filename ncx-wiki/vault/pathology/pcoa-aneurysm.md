---
title: Posterior Communicating Artery Aneurysm
category: pathology
tags:
  - ncx
  - aneurysm
...
- **Fetal PCA** (~20%): The PCoA remains the dominant supply to the [[occipital-lobe]] with a hypoplastic or atretic P1 segment. Must be preserved to avoid occipital infarction.
- **PCoA infundibulum** (~10%): A funnel-shaped dilation at the PCoA origin with the artery emerging from the tip rather than the base. No proven rupture risk; treated only if enlarging.
...
5. **Establish proximal control** -- incise the [[falciform-ligament]] if needed to widen the ICA-optic nerve interval
6. **Expose inferior ICA surface** for the lateral temporary clip blade
...
PCoA aneurysms are typically occluded with a **simple straight clip**:

- **Proximal blade**: applied over the shoulder of the PCoA origin at the anterior neck
- **Distal blade**: applied in front of the AChA at the posterior neck
- Blade tips advanced until they pass the neck; angle adjusted to seat squarely against the ICA
...
- [[mca-aneurysm]] -- most common aneurysm for clipping
- [[acoa-aneurysm]] -- also approached via [[pterional-approach]]
- [[ophthalmic-artery-aneurysm]] -- paraclinoid region
- [[basilar-bifurcation-aneurysm]] -- posterior circulation counterpart