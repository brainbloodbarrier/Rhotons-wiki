---
title: Cerebrovascular AVMs Overview
category: synthesis
tags:
  - cerebrovascular
  - avm
...
# Cerebrovascular AVMs Overview

Cerebral arteriovenous malformations are tangles of dysplastic arteries and veins that shunt blood without an intervening capillary bed. Lawton's framework organizes the full spectrum into **seven AVM types** based on location, each with predictable subtypes, [[avm-feeding-arteries|arterial supply]], [[avm-draining-veins|venous drainage]], and surgical approaches. This taxonomy -- derived from over 2,500 cases at UCSF -- transforms AVM surgery from an improvised response to a systematic plan.
...
## Unifying Surgical Tenets

Regardless of type, all AVM resections follow the same four-phase sequence described in [[avm-resection-principles]]:
...
The [[spetzler-martin-grading|Spetzler-Martin grading system]] (size + eloquence + venous drainage) provides an initial risk estimate. The supplementary Lawton-Young system (age + hemorrhagic presentation + compactness) refines selection. Combined score <=6 suggests acceptably low surgical risk.

| Management Tier | SM Grade | Approach |
|---|---|---|
| Surgical | I-II (Class A) | [[microsurgery\|Microsurgical]] resection |
| Multimodal | III (Class B) | Embolization + [[radiosurgery]] +/- surgery |
| Conservative | IV-V (Class C) | Observation unless recurrent hemorrhage |

## Arterial Supply Fingerprints

Each AVM subtype has a unique combination of [[avm-feeding-arteries|feeding arteries]] (terminal, transit, perforator, choroidal, bystander). The fingerprint enables pre-operative planning of the dissection sequence. Feeding arteries are progressively throttled during circumdissection, depressurizing the nidus until it resembles a [[cavernoma|cavernous malformation]].
...
[[avm-draining-veins|Venous drainage]] is the single most important intraoperative consideration. The primary vein must be preserved until the final moment. Each AVM type has a predictable primary vein (e.g., Labbe for lateral temporal, ICV for ventricular body). The draining vein serves as compass (guiding dissection to subcortical nidus) and odometer (color change from red to blue measures progress).
...
### AVM Concept Pages
- [[avm-feeding-arteries]] -- Terminal, transit, perforator, choroidal, bystander classification
- [[avm-draining-veins]] -- Venous preservation, compass/odometer, primary vs secondary
- [[avm-resection-principles]] -- Four-phase circumdissection sequence

### Classification
- [[spetzler-martin-grading]] -- SM + Lawton-Young supplementary + 3-tier system

### Related Cerebrovascular Pages
- [[cerebrovascular-aneurysms-overview]] -- Companion synthesis for aneurysm surgery
- [[pcoa-aneurysm]] -- PCoA aneurysms (ICA-PCoA junction)
- [[mca-aneurysm]] -- MCA bifurcation aneurysms
- [[acoa-aneurysm]] -- ACoA aneurysms
- [[basilar-bifurcation-aneurysm]] -- Basilar tip aneurysms
- [[pica-aneurysm]] -- PICA aneurysms
- [[ophthalmic-artery-aneurysm]] -- Ophthalmic artery aneurysms
- [[pericallosal-artery-aneurysm]] -- Pericallosal artery aneurysms
- [[temporary-clipping]] -- Flow arrest principles shared with AVM surgery
- [[intraoperative-rupture]] -- Rupture management across AVM and aneurysm surgery