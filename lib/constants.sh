...
# crossmap-generate.sh, crosswiki-migrate.sh.
...
# backslash. Single source of truth for the guard, crossmap generator, and
# cross-wiki migrator — keep behavior identical across all three.
normalize_target() {
